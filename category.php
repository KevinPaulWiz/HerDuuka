...
// WHERE products.product_id='$id'";
 ...
 echo $row['category_name']; ?>   </a></li>
                ...
                foreach ($subcat as $cat_img) {
                  // $new_sub=$sub['category_id'];
                 ?>
                                <div class="item " >
                                   <a href="#"><img src="admin/<?php echo $cat_img['image_path']; ?>" alt="<?php echo $cat_img['file_name']; ?>"></a>
                                </div>
                               <?php } ?>
                            </div>
                        </div><!-- images categori -->
           ...
           <?php
                ...
                foreach ($subcat as $sub) {
                  // $new_sub=$sub['category_id'];
                 ?>
                            <li><a href="category-sub?FMfcgxwHMsSwchhKpzVNjmvvNDQmDWxH=ALeKk00B5oNZEMbYSCnkFSzNInJ_GNCfY&category=<?php echo $sub['category_id']; ?>"><?php echo $sub['category_name'] ?></a></li>
                            <?php } ?>
                        </ul><!-- link categori -->
...
<?php   
          include 'config/connection.php';
          $sql = "SELECT * FROM products WHERE category_id='".$sub['category_id']."'";
          $query = $pdo->prepare($sql);
          $query->execute();
          $row = $query->fetchAll(PDO::FETCH_ASSOC);  
...
$row = $result->fetch_assoc();
?>
                                                <a href="#" class="product-item-img"><img src="admin/<?php echo $row['image_path']; ?>" alt="<?php echo $row['product_name']; ?>"></a>
                                                <div class="product-item-actions">
                                                    <a href="#" class="btn btn-wishlist"><span>wishlist</span></a>
                                                    <a href="#" class="btn btn-compare"><span>compare</span></a>
                                                    <a href="#" class="btn btn-quickview"><span>quickview</span></a>
...
<?php
 ...
 ?>
                    ...
                    <div class="col-md-3 col-md-pull-9  col-sidebar">
                        ...
                        <div class="block-sidebar block-sidebar-categorie">
                          ...
                          ?>
                                    ...
                                    <li class="parent">
                                        <a href="category-sub?FMfcgxwHMsSwchhKpzVNjmvvNDQmDWxH=ALeKk00B5oNZEMbYSCnkFSzNInJ_GNCfY&category=<?php echo $cat_col['category_id']; ?>"><?php echo $cat_col['category_name']; ?></a>
                ...
                foreach ($subcat as $sub_prod) {
                    ?>
                                            <li ><a href="category-third-sub?FMfcgxwHMsSwchhKpzVNjmvvNDQmDWxH=ALeKk00B5oNZEMbYSCnkFSzNInJ_GNCfY&category=<?php echo $sub_prod['category_id']; ?>"><?php echo $sub_prod['category_name']; ?></a></li>
                                               <?php } ?>
                                        </ul></li>
                              <?php } ?>       
                                </ul>
