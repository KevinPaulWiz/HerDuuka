             ...
             <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs mb-3  col-md-12" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active"  href="suppliers" role="tab"
                                       aria-controls="home" aria-selected="true">Pending</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"  href="suppliers-approved" >Approved</a>
                                </li>
                                <li class="nav-item">
 ...
 <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">  
  <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive " cellspacing="0" width="100%">
                ...
                <?php    
                  ...
                  $sql_query = "SELECT * FROM `shops` WHERE status='Processing' ORDER BY `shops`.`shop_id` DESC";
                ...
                <div class="dropdown-menu dropdown-menu-left">
                  ...
                  <a class="dropdown-item" href=""><i class="fa fa-eye-slash"> </i> Disbale</a>
                    <a class="dropdown-item" href="javascript::void(0);" data-role="approve"
                      data-id="<?php echo $id; ?>" id="<?php echo $id; ?>"><i class="fa fa-check-square"> </i> Approve</a>
                </div>
                </div>
                </td>
                 ...
                 ?></span></td>
                  ...
                  <td><span class="badge bg-warning text-black"><?php echo $rows['status']; ?></span></td>
