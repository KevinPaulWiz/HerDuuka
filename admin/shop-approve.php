...
include 'config/connection.php';
        ...
        $year=date("Y");
        $month=date("M");
        $sql = "SELECT shop_id, shopname,CompanyEmail FROM `shops` WHERE shop_id='$id'";
...
if ($result->num_rows > 0) {
 ...
 $action="Approved a Shop of Shop No <b>$shop_id</b> and Name <b>$name </b>";
    ...
    $sql = "UPDATE shops SET status='Approved' WHERE shop_id='$id'";
/****************Sending Email approval*********************/
$subject="Seller Account Approved";
$ReplyEmail="vendor@alipata.com";
$to = $Email;
  // Other variabkles
                            ...
                            <td width='600' style=' background-color:#f1f6fa !important; -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(102, 175, 233, .6); border-radius: 10px;'>
                                ...
                                <table class='m_-4380193512371063790bodycontent' width='100%' cellspacing='0' style='padding-top:15px;'>
                                    <tbody><tr align='center'>
                                       ...
                                       <span style='font-size: 1.2em; text-transform: center ;'>Welcome and thank you for registering with Alipata.com!</span>
<p style=''>
Your account has now been Approved and you can log in by using your email address and password by visiting our website or click on the button below:
</p>
<a style='background-color: #ff4d01; border-radius:5px; text-transform: uppercase; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; ' href='http://alipata.com/seller/' title='Verify email address' target='_blank' data-saferedirecturl=''>Login</a>
    
  <p>
Thank you for Choosing Alipata.</p> 
            ...
            <td valign='top' style='padding-top:9px'>
                ...
                <table align='left' border='0' cellpadding='0' cellspacing='0' style='max-width:100%;min-width:100%;border-collapse:collapse' width='100%'>
                    <tbody><tr>
                        ...
                        <td valign='top' style='padding-top:0;padding-right:18px;padding-bottom:9px;padding-left:18px;word-break:break-word;color:#6e6e6e;text-align:left'>
                        
                            <div style='text-align:justify'><strong id='m_7105912061975757345m_6132091085501966376docs-internal-guid-87a02d8e-7fff-f14b-034b-23e6395dad69'>Your dedicated <span class='il'>Alipata</span> team.</strong><br>
<br>
For further inquiries, Please&nbsp;contact us via email <strong><a href='mailto:vendor@alipata.com' style='color:#007c89;font-weight:normal;text-decoration:underline' target='_blank'>vendor@<span class='il'>alipata</span>.com</a></strong> &nbsp;or call us on&nbsp;<strong>  +256 702 978 248.</strong></div>
...
<div class='m_-5759555038152462244block-grid' style='Margin:0 auto;min-width:320px;max-width:600px;word-wrap:break-word;word-break:break-word;background-color:#ffffff'>
<div style='border-collapse:collapse;display:table;width:100%;background-color:#ffffff'>


<div class='m_-5759555038152462244col' style='min-width:320px;max-width:600px;display:table-cell;vertical-align:top;width:600px'>
<div style='width:100%!important'>

<div style='border-top:0px solid transparent;border-left:0px solid transparent;border-bottom:0px solid transparent;border-right:0px solid transparent;padding-top:5px;padding-bottom:5px;padding-right:0px;padding-left:0px'>

<div align='center' style='padding-right:0px;padding-left:0px'>
<a href='http://link.brightermonday.co.ug/click/20752611.89114/aHR0cHM6Ly9hcHBseS51bmljYWYub3JnL3VuaWNhZi1tdWx0aXBhcnRuZXIvdXUtdW9zLWxqbXUvdWdhbmRhP3V0bV9zb3VyY2U9Uk9BTS1CcmlnaHRlck1vbmRheS1VZ2FuZGEmdXRtX21lZGl1bT1uZXdzbGV0dGVyLW1vbnRoMyZ1dG1fY2FtcGFpZ249Uk9BTS0yMDIwLTMtMw/5a61bb50e9a8a2425b8b4d7cC0595c38a' style='outline:none' target='_blank' data-saferedirecturl='https://www.google.com/url?q=http://link.brightermonday.co.ug/click/20752611.89114/aHR0cHM6Ly9hcHBseS51bmljYWYub3JnL3VuaWNhZi1tdWx0aXBhcnRuZXIvdXUtdW9zLWxqbXUvdWdhbmRhP3V0bV9zb3VyY2U9Uk9BTS1CcmlnaHRlck1vbmRheS1VZ2FuZGEmdXRtX21lZGl1bT1uZXdzbGV0dGVyLW1vbnRoMyZ1dG1fY2FtcGFpZ249Uk9BTS0yMDIwLTMtMw/5a61bb50e9a8a2425b8b4d7cC0595c38a&amp;source=gmail&amp;ust=1594475976399000&amp;usg=AFQjCNHTgLEY9KP_7YnaLdHwqmx91o-9_Q'> <img align='center' border='0' src='http://alipata.com/images/media/Stay-safe-CB-1170px.png' alt='Alternate text' title='Alternate text' style='text-decoration:none;height:auto;border:0;width:100%;max-width:600px;display:block' width='600' class='CToWUd'></a>
...
// Additional headers
$headers .= "From:  Seller Account Approved<$ReplyEmail>" . "\r\n";
$headers .= "Cc: $ReplyEmail" . "\r\n";
$headers .= "Bcc: $ReplyEmail" . "\r\n";

// Send email
if(mail($to,$subject,$htmlContent,$headers)):
    $Error = 'Email has sent successfully.';
