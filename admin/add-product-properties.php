    ...
    <?php 
        if (isset($_POST['addProperties'])) {
            ...
            for ($i=0; $i <count($sizesArr) ; $i++) { 
                if (!empty($product_id)&&!empty($quantityArr[$i])&&!empty($sizesArr[$i])) {
                    $sizes = addslashes($sizesArr[$i]);
                    $quantity = addslashes($quantityArr[$i]);
                    $conn->query("INSERT INTO product_size (product_id,size,quantity,submitteddate,submittedby) VALUES('$product_id','$sizes','$quantity','$submitteddate','$submittedby')");
...
<div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
            <form  method="post" action="<?php echo htmlspecialchars($_SERVER[""]);?>" novalidate >
                    <?php echo $Error; ?>
                    <?php echo $statusMsg; ?>
            ...
            <div class="card">
                ...
                <h4 class="card-title float-left text-uppercase"><?php echo $title; ?> <small> (<span class="text-danger"> * </span> fields are Mandatory)</small></h4>
                 ...
                 <button type="submit" name="addProperties" class="btn btn-primary btn-square float-right" title="Save" data-toggle="tooltip"><i class="fa fa-save"></i></button>
                </div>
                </fieldset>
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                        ...
                        <div class="form-group row">
                           ...
                           <div class="fieldGroup form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label text-right font-weight-bold"> Size &amp; Quantity <span class="text-danger font-weight-bold">*</span></label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" id="defaultInput" name="size[]" placeholder="Add size i.e 11' or 11cm X 12cm" required="">
                                        </div>
                                        <div class="col-md-5">
                                            <input type="number" class="form-control" id="defaultInput" name="quantity[]"  placeholder="Add product available quantity" required="">
                                        </div>
                                    <div class=" col-md-2">
