                                ...
                                <span class="avatar-title bg-info-bright text-info rounded">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="mb-0">
                                            <?php 
                                                $today = date('Y-m-d');
                                                echo $conn->query("SELECT product_id from products where statdate = '$today'")->num_rows;
                                             ?>
                                        </h4>
                                    </div>
                                </a>
                            ...
                            <li>
                                ...
                                <span class="avatar-title bg-danger-bright text-danger rounded">
                                    ...
                                    <div>
                                        <h6>Refunds</h6>
                                        <h4 class="mb-0">
                                            <?php echo number_format($conn->query("SELECT category_id from category")->num_rows); ?>
                                        </h4>
                                    </div>
                                </a>
                            </li>
