                            ...
                            <td>
                              <div class="dropdown ml-1">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item" data-toggle="tooltip" data-role="back" data-id="<?php echo $id; ?>" id="<?php echo $id; ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Out for Delivery</a>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $(document).on('click','a[data-role=back]',function(){
            var id = $(this).attr("id");
            if (confirm("Move Out for Delivery step?")) {
                $.ajax({
                    type: "POST",
