             ...
             <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs mb-3  col-md-12" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="orders-in-delivery">In Delivery</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <td>
                              <div class="dropdown ml-1">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-left">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item" data-toggle="tooltip" data-role="next" data-id="<?php echo $id; ?>" id="<?php echo $id; ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i> Next Step</a>
                                    <a href="javascript:void(0);" class="dropdown-item" data-toggle="tooltip" data-role="back" data-id="<?php echo $id; ?>" id="<?php echo $id; ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back Step</a>
