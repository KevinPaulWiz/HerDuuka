    ...
    <span class="text-uppercase"> information<br><b style="border-top: 2px solid #ddd;" class=" ml-1  font-weight-bold h4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></span>
      ...
      <?php 
       include 'config/connection.php';
                    $result_address = $conn->query("SELECT * FROM addresses WHERE default_address='1' AND customerid='".$_SESSION['customerid']."'");
      ...
      if (!$_SESSION['customer_email'] && !$_SESSION['customerid']) {
       ?>
                    <div class="box-border rounded">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <button type="submit" name="login_checkout" class="button">Login</button>
                            </form>
                            </div>
                    ...
                    <?php
                      }elseif ($result_address->num_rows > 0) {
                        // echo "Found";
                     // }elseif (!empty($row_customer['address'])) {
                      $row_address = $result_address->fetch_assoc();
                        ...
                        <div class="p-4 mt-0">
                        <div class="cont brdt"> <div class="color-default -fwm ft-address-name font-weight-bold"><?php echo $row_address['fname']." ".$row_address['lname']; ?></div><div class="color-default-800 -fs-13"><div class="-block ft-address-location"><?php echo $row_address['address']; ?>,<br> <?php echo $row_address['other_information']; ?>,<br> <?php echo $row_address['region']; ?></div><div class="-block ft-address-phone"><?php echo $row_address['phone']; ?></div></div></div>
                        </div>
                        </div> 
                        &nbsp;   
                        </div>
...
<div class="block-newletter float-right">
    <div class="block-content">
        <div class="pr-4 float-right p-0 m-0">
...
<div class="col-sm-12 pt-4">
                        <button type="submit" name="update_customer_details" class="button active  btn btn-default col-sm-12 form-group">Continue</button>
                        </div>
                            </li>
...
$total, 0, '.', ',');; ?></span>  
    ...
    <?php } ?>
            <div align="center" class="-align-center p-2 -mtxxl"><a class="btn btn-default font-weight-bold color-primary" href="cart">Modify Cart</a>
                </div></aside> 
            </div> 
            </div> 
            </div>
