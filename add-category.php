...
<?php include 'main/controllers.php'; ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <div class="img">
  <input type="file" class="form-control" name="description" placeholder="description">
</div>
    </div>
  </div>
...
<?php   } ?>
  ...
  <div class="form-group row">
    <label for="meta_tag_title" class="col-sm-2 col-form-label">Meta tag title</label>
    <div class="col-sm-10">
