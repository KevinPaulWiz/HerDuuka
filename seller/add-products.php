...
include 'config/connection.php';
/*************************Adding Products*****************************/
$result = mysqli_query($conn,  "SELECT product_id FROM products ORDER BY product_id DESC LIMIT 1");
...
<?php   } ?>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" required="" name="files[]" multiple="" class="form-control dropzone" id="inputEmail3" placeholder="Images">
