...
<?php   include '../admin/main/controllers.php'; ?>
 ...
 <div class="x_panel">
                ...
                <tbody>
                  ...
                  $sql_query = "SELECT * FROM `products` WHERE shop_id='".$_SESSION['shop_id']."' ORDER BY `products`.`product_id` DESC ";
              ...
              ?>
                 ...
                 ?></span></td> 
                  <td class="small"><?php echo $rows['product_name']; ?></td>
                  <td class="small"><?php echo $rows['Model']; ?></td>
                  <td><?php echo "UGX"; echo number_format($rows['Price'], 0, '.', ','); ?></td>
