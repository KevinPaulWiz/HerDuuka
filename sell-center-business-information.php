...
elseif ( empty($filetmp_reg_doc_details) && empty($filetmp_VATInformationFile)){
    ...
    // $Error= $stmt->rowCount() . " records UPDATED successfully";
     echo "<script type=\"text/javascript\">
                  window.location = \"sell-center-payment-details\"
                </script>";
    }
...
<span class="help-block help-block-column"> <label class="inline ml-2 p-0" for="signup_agreements_policy"> I have read and accepted the Terms of Alipata</label><a href="/user/signup/tcagreementcontent/page/79" data-modalprint="true"> Policy </a></span>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" value="<?php echo $row_seller['CompanyAddress1']; ?>" class="form-control" name="CompanyAddress1" placeholder="Company Address 1">
    </div>
  </div>
  <div class="form-group row">
...
<div class="form-group row">
    <label for="email" class="col-sm-3 col-form-label text-right">SKU Category<span class="text-primary" title="Stock Keeping Unit Category" data-toggle="tooltip">
...
<div class="form-group row">
    <label for="email" class="col-sm-3 col-form-label text-right">Number of SKU <span class="text-primary" title="Number of Stock Keeping Unit" data-toggle="tooltip">
                                           <i class="fa fa-question-circle"></i>
                                        </span></label>
    <div class="col-sm-9">
